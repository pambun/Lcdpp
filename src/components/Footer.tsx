        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 lg:col-span-1">
            ...
            <div className="flex gap-4">
              <a href="https://x.com/home" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-full transition-colors"><Twitter size={18} /></a>
              <a href="https://www.linkedin.com/company/african-centre-for-diplomacy-and-public-policy/" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-full transition-colors"><Linkedin size={18} /></a>
              <a href="https://web.facebook.com/profile.php?id=61576623303140" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-full transition-colors"><Facebook size={18} /></a>
            </div>
          </div>
